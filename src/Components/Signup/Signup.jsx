            ...
            <div className="card flex-shrink-0 w-full max-w-sm shadow-lg bg-base-100">
                <div className="card-body">
                    ...
                    <div className="form-control">
                        ...
                        className="input input-bordered" />
                        <label className="label">
                            <span className="">Already have an account? Please <Link to="/signin" className="text-customred">Sign In</Link></span>
                        </label>
                    </div>
                    <div className="form-control mt-6">
                        <button className="btn bg-customblue text-[#fff]  hover:bg-hoverblue">Sign Up</button>
                    </div>
                    </form>
