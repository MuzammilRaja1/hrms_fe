        ...
        <div className="w-[80%] ml-[20%] mt-[-17%] md:mt-[1%] lg:w-[100%] md:ml-[5%] md:w-[90%] lg:ml-[0] lg:mt-0 navbar md:pl-[45px] md:pr-[22px] nav-bg ">
            ...
            <div className="flex-none gap-3">
                <label className="cursor-pointer grid place-items-center">
                    <input type="checkbox" onClick={toogleDarkMode}  className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2 border-2 w-14 h-8 border-customblue" style={{background: '#1e67a9'}} />
                ...
                </label>
                {
                    ...
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                        <div className="w-12 rounded-full">
                            <img alt="profile" src={user?.photoURL ? user?.photoURL : "https://i.ibb.co/2qr381T/user-1.png"} />
                        </div>
