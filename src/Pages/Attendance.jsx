...
const Attendance = () => {
    ...
    return (
        <div className="attendance w-10/12 mx-auto bg-white border border-customblue dark:bg-[#222222] p-10">
            ...
            {loading ? (
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <table className="table-auto w-full">
                        <thead className="text-xs font-semibold uppercase text-white bg-customblue ">
                            <tr>
                    ...
                    <div className='flex justify-end mt-10'>
                        <button type="submit" className='bg-customblue btn text-white hover:bg-hoverblue hover:text-white'>Save Attendance</button>
                    </div>
                </form>
            )}
        </div>
