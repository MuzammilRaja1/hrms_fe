  ...
  useEffect(() => {
    if (singleEmployee) {
      setFormData({
        ...
        hire_date: singleEmployee[0]?.hire_date
          ? new Date(singleEmployee[0]?.hire_date).toISOString().substr(0, 10)
          : "", 
    ...
    <div className="md:w-7/12 mx-auto mt-10 px-2">
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <button
            type="submit"
            className="btn-md w-36 bg-customblue hover:bg-hoverblue text-white font-bold rounded focus:outline-none focus:shadow-outline"
          >
            Submit
          </button>
        </div>
